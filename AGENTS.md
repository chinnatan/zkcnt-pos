...
4. ก่อนปิดงาน อัปเดตไฟล์ plan (เช่น `sub-plan-*.md`): ติ๊ก `[x]` พร้อมบันทึกผลลัพธ์ / ข้อที่สรุปว่าไม่ต้องทำจริง
5. Commit message เป็นภาษาไทยรูปแบบ Conventional Commits: `<type>(<scope>): <ใจความภาษาไทย>`
